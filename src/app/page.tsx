...
import { Zap, Shield, Palette, Bot, Workflow, CreditCard, Code, Github, Star, Users, Rocket } from "lucide-react";
      ...
      <section className="container space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="mx-auto flex max-w-[64rem] flex-col items-center space-y-4 text-center">
          <Badge variant="outline" className="text-sm">
            ...
            Production-Ready AIaaS Boilerplate
          </Badge>
          ...
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            ...
            automation tools, and modern UI components. Everything you need to launch your AIaaS.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <Link href="https://github.com/Vesias/AIaaS-Boilerplate-Framework">
          ...
          <Card className="border-0 bg-background/60 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            ...
            <CardContent className="space-y-4">
              <div className="rounded-lg bg-muted p-4 font-mono text-sm">
                ...
                <div>git clone https://github.com/Vesias/AIaaS-Boilerplate-Framework.git</div>
      ...
      <footer className="border-t bg-background/60 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0">
          ...
          <div className="flex items-center space-x-4">
            <Link href="https://github.com/Vesias/AIaaS-Boilerplate-Framework" className="text-muted-foreground hover:text-foreground">
